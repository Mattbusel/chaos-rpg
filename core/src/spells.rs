//! Spell generation — 7 schools, 147 named spells, cooldowns, spell levels.
//!
...
impl SpellSchool {
    ...
    pub fn color(&self) -> &'static str {
        match self {
            SpellSchool::Fire => "\x1b[91m",
            SpellSchool::Ice => "\x1b[96m",
            SpellSchool::Lightning => "\x1b[93m",
            SpellSchool::Arcane => "\x1b[95m",
            SpellSchool::Nature => "\x1b[92m",
            SpellSchool::Shadow => "\x1b[35m",
            SpellSchool::Chaos => "\x1b[97m",
        }
    }
...
// fx_idx indices into SIDE_EFFECTS
const FX_SELF_DMG: usize = 0;
const FX_TELE: usize = 1;
const FX_GRAV: usize = 2;
const FX_HOSTILE: usize = 3;
const FX_STATS: usize = 4;
const FX_SHAKE: usize = 5;
const FX_NPC: usize = 6;
const FX_RAND: usize = 7;
const FX_LEARN: usize = 8;
const FX_OLDER: usize = 9;
const FX_YOUNGER: usize = 10;
const FX_DOOR: usize = 11;
const FX_EMBAR: usize = 13;
const FX_NONE: usize = 14;
const FX_GOLD: usize = 15;
const FX_FIRE: usize = 16;
...
const SIDE_EFFECTS: &[&str] = &[
    "caster takes equal damage",                              // 0
    "caster is teleported 1d6 rooms away",                    // 1
    "gravity reverses for 3 turns",                          // 2
    "all NPCs in the area become temporarily hostile",        // 3
    "nothing visible happens but your stats secretly change", // 4
    "the screen shakes violently",                           // 5
    "a new NPC spawns and is immediately confused",          // 6
    "the spell targets a random entity",                     // 7
    "the spell learns from this experience and grows slightly stronger", // 8
    "you age 10 years",                                      // 9
    "you age -10 years (become younger)",                    // 10
    "a door appears",                                        // 11
    "a door disappears",                                     // 12
    "nearby enemies are mildly embarrassed",                 // 13
    "No visible side effect (suspicious)",                   // 14
    "you gain 1 gold",                                       // 15
    "caster is briefly on fire (cosmetic only)",             // 16
];
